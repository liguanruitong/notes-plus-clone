...
const store = new Store({
  ...
  defaults: {
    ...
    settings: {
      ...
      themeColor: "#007AFF",
      pens: [
        { kind: "pen",         tool: "pen",         color: "#1c1c1e", size: 3,  opacity: 1,    pWidth: true,  pWidthAmt: 0.5, pAlpha: false, pAlphaAmt: 0.5 },
        { kind: "highlighter", tool: "highlighter", color: "#ffd60a", size: 16, opacity: 0.35, pWidth: false, pWidthAmt: 0.5, pAlpha: false, pAlphaAmt: 0.5 },
      ],
      customTemplates: [],
      folders: [],
